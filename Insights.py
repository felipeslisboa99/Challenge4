...
def app():
    ...
    st.markdown(
        ...
        <iframe 
            ...
            width="100%" 
            height="600" 
            src="https://app.powerbi.com/view?r=eyJrIjoiNTAzMjZlODYtODM0My00ZDc3LTgxM2QtMmE2ZjhjMmMxNzJiIiwidCI6IjViNjM0YWEwLTFiNTktNDJmOS04YTM5LTBmMWJkY2RiYjA1NSJ9" frameborder="0" allowFullScreen="true"></iframe>"
            frameborder="0"
